...
pkgs2html(list('dsBaseClient','dsModellingClient','dsStatsClient','dsGraphicsClient','dsBetaTestClient','opal','opaladmin'), pkg.cmd, out)
...
pkgs2html(list('dsBase','dsModelling','dsStats','dsGraphics','dsBetaTest'), pkg.cmd, out)
